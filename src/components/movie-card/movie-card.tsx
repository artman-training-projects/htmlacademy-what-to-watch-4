...
const MovieCard: FC<Props> = (props: Props) => {
	const {
		activeTab,
		auth,
		handleFilmFavorite,
		...
		<>
					...
					<div className="movie-card__wrap">
						<div className="movie-card__desc">
							...
							<div className="movie-card__buttons">
								<Link
									to={`${Pages.PLAYER}/${selectedFilm.id}`}
								...
								<button
									...
									onClick={() =>
										isSignIn
											? handleFilmFavorite(selectedFilm)
								...
								{isSignIn && (
									<Link
										to={`${Pages.FILM}/${selectedFilm.id}/review`}
			...
			<div className="page-content">
				<section className="catalog catalog--like-this">
					...
					<MoviesList films={sameFilms} history={history} />
				</section>
