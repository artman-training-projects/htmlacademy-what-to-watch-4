...
import {
	getCurrentGenre,
	getFilmsByGenre,
} from "../../reducer/show-films/selectors";
		...
		<>
						...
						{isLoadingPromo() || (
							<div className="movie-card__desc">
								...
								<div className="movie-card__buttons">
									<Link
										to={`${Pages.PLAYER}/${moviePoster.id}`}
			...
			<div className="page-content">
				<section className="catalog">
					...
					{isLoadingFilms() || (
						<MoviesList films={showFilms} history={history} />
					)}

					{numberOfFilms < filmsByGenre.length && (
						<CatalogMore onShowMoreClick={onCountShowFilmAdd} />
					)}
				</section>
