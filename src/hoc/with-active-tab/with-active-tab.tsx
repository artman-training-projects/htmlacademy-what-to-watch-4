...
const withActiveTab = (Component) => {
	...
	class WithActiveTab extends PureComponent<T, State> {
		constructor(props: Props) {
			...
			this._handleActiveTabChange =
				this._handleActiveTabChange.bind(this);
			this._handleActiveTabRender =
				this._handleActiveTabRender.bind(this);
		}
		...
		_handleActiveTabRender() {
			...
			switch (activeTab) {
				...
				case MovieNavList.REVIEWS:
					return <MovieNavReviews selectedFilm={selectedFilm} />;
				default:
					return ``;
			}
		}
